...
[![My Skills](https://skillicons.dev/icons?i=js,ts,python,docker,postgres,mongodb,firebase,npm,pnpm,git,github,gcp,azure,svelte,notion,react,express,nodejs,svg,vercel,postman,figma,bootstrap,html,css,sass,)](https://kanakkholwal.eu.org)
